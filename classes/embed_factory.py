...
class EmbedFactory:
    ...
    @staticmethod
    def create_admin_embed(config: dict, reason: str = None, cfg_type: str = None, **fields: dict) -> Embed:
    ...
    @staticmethod
    def create_embed(config: dict, cfg_type: str = None, **fields: dict) -> Embed:
